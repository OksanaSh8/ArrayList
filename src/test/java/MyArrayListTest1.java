import oksana.internship.lesson1.model.MyArrayList;
...
public class MyArrayListTest1 {
    ...
    @Test
    void showSortByQuicksort() {
        MyArrayList<Integer> arrayList = createArrayList(25, 34, 1, 71, 92, 2, 4);
        arrayList.quicksortArray();
        MyArrayList<Integer> arrayListSort = createArrayList(1, 2, 4, 25, 34, 71, 92);
        assertTrue(arrayListSort.equals(arrayList));
    }
